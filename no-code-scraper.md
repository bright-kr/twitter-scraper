...
2. "Scrapers Marketplace" 탭을 클릭합니다
...
1. 검색창에서 "Twitter" 또는 "x.com"을 검색합니다
2. Twitter 데이터 수집을 위한 몇 가지 옵션이 표시됩니다.
...
1. 원하는 옵션(예: Posts)을 선택합니다
2. "No-Code Scraper" 옵션을 선택합니다
3. 계속 진행하려면 "Next"를 클릭합니다
...
1. 인터페이스에서 Twitter URL을 직접 추가합니다
2. 또는 여러 URL이 포함된 CSV 파일을 업로드합니다
3. 프로세스를 시작하려면 "Start Collecting"을 클릭합니다
...
1. 데이터 수집이 완료될 때까지 기다립니다
2. 데이터를 가져오려면 "Download" 버튼을 클릭합니다
...
이 프로세스는 게시물, 프로필 또는 기타 Twitter 데이터를 수집할 때도 유사하게 적용됩니다. no-code scraper가 모든 기술적 복잡성을 처리하므로, 다양한 기술 수준의 사용자도 데이터 수집을 쉽게 수행할 수 있습니다.